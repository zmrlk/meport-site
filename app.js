...
const i18n = {
  en: {
    ...
    'hero.sub': 'Drop your files, answer a few questions, and Meport creates your personal ruleset for 14 AI platforms. Six AI providers. Five minutes. One profile. Every AI finally gets you.',
    ...
    'feat.f2.desc': 'Drop your files. Meport extracts your profile automatically. System scanner detects tech stack, locale, AI configs. Only a few questions for the rest.',
    ...
    'priv.ai.desc': 'AI is optional \u2014 only used if you choose AI interview mode or profile enrichment. When used, filtered profile data goes directly to YOUR chosen provider (Claude, OpenAI, Gemini, Grok, OpenRouter, or Ollama for fully offline). 6 providers supported. Meport is never a middleman.',
    ...
    'dl.cli.sub': '23 commands \u00b7 9 packs \u00b7 14 exports \u00b7 6 AI providers',
  ...
  pl: {
    ...
    'hero.sub': 'Wrzu\u0107 pliki, odpowiedz na kilka pyta\u0144, a Meport stworzy Tw\u00f3j osobisty zestaw regu\u0142 dla 14 platform AI. 6 dostawc\u00f3w AI. Pi\u0119\u0107 minut. Jeden profil. Ka\u017cde AI wreszcie Ci\u0119 rozumie.',
    'hero.cta': 'Zacznij',
    ...
    'feat.f2.desc': 'Wrzu\u0107 pliki. Meport tworzy profil automatycznie. Skaner wykrywa tech stack, lokalizacj\u0119, konfigi AI. Tylko kilka pyta\u0144 na reszt\u0119.',
    ...
    'priv.ai.desc': 'AI jest opcjonalne \u2014 u\u017cywane tylko w trybie wywiadu AI lub wzbogacania profilu. Przefiltrowane dane id\u0105 bezpo\u015brednio do TWOJEGO dostawcy (Claude, OpenAI, Gemini, Grok, OpenRouter lub Ollama do pe\u0142nego offline). 6 dostawc\u00f3w. Meport nigdy nie jest po\u015brednikiem.',
    ...
    'dl.cli.sub': '23 komendy \u00b7 9 paczek \u00b7 14 eksport\u00f3w \u00b7 6 dostawc\u00f3w AI',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (ptBody) {
    const lines = [
      ...
      { html: '&nbsp;', d: 300 },
      { html: '<span class="tc-a">M\u2192</span> <span class="tc-w">Meport v0.1.5</span>', d: 500 },
      { html: '&nbsp;', d: 700 },
