...
const i18n = {
  en: {
    ...
    'hero.sub': 'Drop your files, answer a few questions, and Meport creates your personal ruleset for 13 AI platforms. Six AI providers. One profile. Every AI finally gets you.',
    ...
    'tracks.p.l4': '13 platform exports',
    ...
    'price.p.l2': 'All 13 platform exports',
    ...
    'story.p7': 'One command. Drop your files. 38+ dimensions of who you are across 10 categories. Export to 13 platforms. 6 AI providers. Everything local. Everything free. Everything open source.',
    'story.role': 'Creator of Meport \u00b7 ISIKO',

    'compare.eyebrow': 'Choose your way',
    'compare.heading': 'Desktop App & CLI available now.',
    ...
    'compare.r4': 'Export to 13 platforms',
    ...
    'dl.cli.sub': '25 commands \u00b7 9 packs \u00b7 13 exports \u00b7 6 AI providers',
    'dl.coming_line': 'Also: <strong>CLI</strong> via <code>npx meport</code>',
    'dl.coming': 'Available now',
  ...
  pl: {
    ...
    'hero.sub': 'Wrzu\u0107 pliki, odpowiedz na kilka pyta\u0144, a Meport stworzy Tw\u00f3j osobisty zestaw regu\u0142 dla 13 platform AI. 6 dostawc\u00f3w AI. Jeden profil. Ka\u017cde AI wreszcie Ci\u0119 rozumie.',
    'hero.cta': 'Zacznij',
    ...
    'tracks.p.l4': '12 eksport\u00f3w platform',
    ...
    'price.p.l2': 'Wszystkie 12 eksport\u00f3w platform',
    ...
    'story.p7': 'Jedno polecenie. Wrzu\u0107 pliki. 38+ wymiar\u00f3w tego, kim jeste\u015b w 10 kategoriach. Eksport na 13 platform. 6 dostawc\u00f3w AI. Wszystko lokalne. Wszystko za darmo. Wszystko open source.',
    'story.role': 'Tw\u00f3rca Meport \u00b7 ISIKO',

    'compare.eyebrow': 'Wybierz sw\u00f3j spos\u00f3b',
    'compare.heading': 'Desktop i CLI dost\u0119pne teraz.',
    ...
    'compare.r4': 'Eksport na 13 platform',
    ...
    'dl.cli.sub': '20+ komend \u00b7 9 paczek \u00b7 12 eksport\u00f3w \u00b7 6 dostawc\u00f3w AI',
    'dl.coming_line': 'R\u00f3wnie\u017c: <strong>CLI</strong> przez <code>npx meport</code>',
    'dl.coming': 'Dost\u0119pne',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (ptBody) {
    const lines = [
      ...
      { html: '&nbsp;', d: 300 },
      { html: '<span class="tc-a">M\u2192</span> <span class="tc-w">Meport v0.2.5</span>', d: 500 },
      { html: '&nbsp;', d: 700 },
